...
class MyPolls extends HookWidget {
  ...
  /// If the callback returns true, the tapped [MyPollOption] is considered as voted.
  /// Else Nothing happens,
  final Future<bool> Function(MyPollOption pollOption, int newTotalVotes)
      onVoted;
  ...
  /// pollOptions = [
  ///
  ///  MyPollOption(id: 1, title: Text('Option 1'), votes: 2),
  ///
  ///  MyPollOption(id: 2, title: Text('Option 2'), votes: 5),
  ///
  ///  MyPollOption(id: 3, title: Text('Option 3'), votes: 9),
  ///
  ///  MyPollOption(id: 4, title: Text('Option 4'), votes: 2),
  ///
  /// ]
  ///
  ...
  final List<MyPollOption> pollOptions;
  ...
  /// Loading animation widget for [MyPollOption] when [onVoted] callback is invoked
  ...
  Widget build(BuildContext context) {
    ...
    final votedOption = useState<MyPollOption?>(hasVoted == false
        ? null
        : pollOptions
            .where(
